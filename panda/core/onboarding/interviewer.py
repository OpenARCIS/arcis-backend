...
from panda.core.llm.prompts import INTERVIEWER_PROMPT, MEMORY_EXTRACTOR_PROMPT
from panda.core.llm.long_memory import long_memory
from panda.core.llm.short_memory import db_client

logger = logging.getLogger(__name__)

# MongoDB collection for onboarding sessions
_db = db_client["panda_short_memory"]
